// Soft-rounded icon set, 24x24 viewBox, stroke 1.8, linejoin=round.
// Ported from the designer's icons.jsx — same paths, typed as React
// function components so callers can do <Ic.Home /> directly.
...
function mk(paths: ReactNode): IconComponent {
...
export const Ic = {
  ...
  Settings: mk(
    <>
      ...
      <path d="M19 12a7 7 0 0 0-.1-1.2l2-1.5-2-3.5-2.3.9a7 7 0 0 0-2-1.2L14 3h-4l-.6 2.5a7 7 0 0 0-2 1.2l-2.3-.9-2 3.5 2 1.5a7 7 0 0 0 0 2.4l-2 1.5 2 3.5 2.3-.9a7 7 0 0 0 2 1.2L10 21h4l.6-2.5a7 7 0 0 0 2-1.2l2.3.9 2-3.5-2-1.5a7 7 0 0 0 .1-1.2z" />
    </>,
  ),
